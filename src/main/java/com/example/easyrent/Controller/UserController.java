...
//=========Profile Area Start======//
    ...
    public String profile(Model model,@PathVariable int id,HttpSession httpSession){
    ...
    public RedirectView getProfile(Model model,HttpSession httpSession){
        if (httpSessionService.isValid(httpSession)){
            return new RedirectView("/profile/"+profileService.getProfile(httpSessionService.getUserEmail(httpSession)).id);
        }
